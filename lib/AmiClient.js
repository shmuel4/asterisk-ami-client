    ...
    constructor(options){
        ...
        Object.assign(this, {
            ...
            _options: Object.assign({
                ...
                emitEventsById: false,
                emitEventsByIdAndByType: false,
            ...
            .then(amiConnection => {
                ...
                this._connection
                    .on('event', event => {
                        ...
                        if(event && event.ActionID && this._options.emitEventsById){
                            this.emit(`event_by_id_${event.ActionID}`, event);
                        }
                        ...
                        if(event && event.ActionID && event.Event && this._options.emitEventsByIdAndByType){
                            let eventName = this._options.eventTypeToLowerCase ? event.Event.toLowerCase() : event.Event;
                            this.emit(`event_t_${eventName}_id_${event.ActionID}`, event);
                        }
                    })
